        ...
        stage('Release') {
            steps {
                script {
                    ...
                    bat 'aws deploy create-deployment --application-name SIT753 --deployment-group-name YourDeploymentGroup --file-exists-behavior OVERWRITE --file my_application.zip'
                }
            }
        }
    }
